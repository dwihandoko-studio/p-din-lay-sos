...
class Home extends BaseController
{
    ...
    {
        return redirect()->to(base_url('silastri/pengdat/home/data'));
    }
    ...
    public function data()
    {
        ...
        return view('silastri/pengdat/home/index', $data);
    }
    ...
    public function getAktivasiWa()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($id == "wa") {
                ...
                $response->data = view('situgu/pengdat/home/aktivasi/wa', $x);
                return json_encode($response);
            } else if ($id == "email") {
                $x['user'] = $user->data;
                $response = new \stdClass;
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('situgu/pengdat/home/aktivasi/email', $x);
            } else {
                $response = new \stdClass;
                $response->status = 400;
    ...
    public function kirimAktivasiWa()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if ($sended) {
                ...
                $response->status = 200;
                $response->message = "Permintaan diizinkan";
                $response->data = view('situgu/pengdat/home/aktivasi/kode', $x);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
