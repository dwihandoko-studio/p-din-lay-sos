...
class Riwayat extends BaseController
{
    ...
    {
        return redirect()->to(base_url('silastri/pengdat/riwayat/data'));
    }
    ...
    public function data()
    {
        ...
        //     ->where('a.send_to', $id)
        //     ->get()->getResult();
        return view('silastri/pengdat/riwayat/index', $data);
    }
    ...
    public function getNotifShowed()
    {
        ...
        if (count($notifs) > 0) {
            ...
            $response->content = view('situgu/pengdat/notification/pop', $x);
