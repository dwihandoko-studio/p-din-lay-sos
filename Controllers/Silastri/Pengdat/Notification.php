...
class Notification extends BaseController
{
    ...
    {
        return redirect()->to(base_url('silastri/pengdat/notification/data'));
    }
    ...
    public function data()
    {
        ...
        $data['notifs'] = $this->_db->table('_notification_tb a')
            ...
            ->get()->getResult();
        return view('silastri/pengdat/notification/index', $data);
    }
    ...
    public function getNotifShowed()
    {
        ...
        if (count($notifs) > 0) {
            ...
            $response->content = view('silastri/pengdat/notification/pop', $x);
