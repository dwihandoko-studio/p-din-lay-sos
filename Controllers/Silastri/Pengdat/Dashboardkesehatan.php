...
class Dashboardkesehatan extends BaseController
{
    ...
    {
        return redirect()->to(base_url('silastri/pengdat/dashboardkesehatan/data'));
    }
    ...
    public function data()
    {
        ...
        $data['user'] = $user->data;
        $data['title'] = 'Dashboard Kesehatan';
        return view('silastri/pengdat/dashboardkesehatan/index', $data);
    }
