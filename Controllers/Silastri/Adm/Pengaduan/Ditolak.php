...
use App\Models\Silastri\Adm\Pengaduan\DitolakModel;
use Config\Services;
...
class Ditolak extends BaseController
{
    ...
    {
        return redirect()->to(base_url('silastri/adm/pengaduan/ditolak/data'));
    }
    ...
    public function data()
    {
        ...
        return view('silastri/adm/pengaduan/ditolak/index', $data);
    }
        ...
        if (!$this->validate($rules)) {
            ...
            if ($current) {
                ...
                if ($granted) {
                    ...
                    $response->data = view('silastri/adm/pengaduan/ditolak/detail', $data);
                    return json_encode($response);
                } else {
                    $response = new \stdClass;
                    $response->status = 400;
