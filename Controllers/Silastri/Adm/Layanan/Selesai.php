...
class Selesai extends BaseController
{
    ...
    private function createExcelReportPBI($data, $tgl_awal, $tgl_akhir)
    {
        ...
        foreach ($data as $item) {
            ...
            $sheet->setCellValue('D' . $row, $item['nama'] ? strtoupper($item['nama']) : '');
            $sheet->setCellValue('E' . $row, $item['jenis_kepesertaan'] ?? '');
            $sheet->setCellValue('F' . $row, $item['tempat_lahir'] ? strtoupper($item['tempat_lahir']) : '');
            ...
            $sheet->setCellValue('J' . $row, $item['alamat'] ? strtoupper($item['alamat']) : '');
            ...
            $sheet->setCellValue('O' . $row, $item['nama_kecamatan'] ? strtoupper($item['nama_kecamatan']) : '');
            $sheet->setCellValue('P' . $row, $item['kode_kampung'] ?? '');
            $sheet->setCellValue('Q' . $row, $item['nama_kampung'] ? strtoupper($item['nama_kampung']) : '');
            $sheet->setCellValue('R' . $row, $item['kode_faskes'] ?? '');
            $sheet->setCellValue('S' . $row, $item['nama_faskes'] ? strtoupper($item['nama_faskes']) : '');
            $sheet->setCellValue('T' . $row, $item['keterangan'] ? strtoupper($item['keterangan']) : '');
