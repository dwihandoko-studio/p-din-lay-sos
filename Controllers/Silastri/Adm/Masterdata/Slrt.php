...
namespace App\Controllers\Silastri\Adm\Masterdata;

use App\Controllers\BaseController;
use App\Models\Silastri\Adm\Masterdata\SlrtModel;
use Config\Services;
...
class Slrt extends BaseController
{
    ...
    {
        return redirect()->to(base_url('silastri/adm/masterdata/slrt/data'));
    }
    ...
    public function data()
    {
        ...
        return view('silastri/adm/masterdata/slrt/index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if (count($current) > 0) {
                ...
                $response->data = view('silastri/adm/masterdata/slrt/detail', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
