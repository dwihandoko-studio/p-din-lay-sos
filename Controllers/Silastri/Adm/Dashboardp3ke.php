            ...
            if (!$this->validate($rules)) {
                ...
                switch ($id) {
                    case 'rekap_p3ke_perkecamatan':
                        ...
                        $response->data = view('silastri/adm/dashboardp3ke/statistik_rekap_p3ke_kecamatan', $x);
                        return json_encode($response);
                        break;
                    case 'rekap_p3ke_verval':
                        ...
                        $response->status = 200;
                        $response->message = "dikenali.";
                        $response->data = view('silastri/adm/dashboardp3ke/statistik_rekap_p3ke_verval', $x);
                        return json_encode($response);
                        break;
                    case 'air_minum':
                        ...
                        $response->status = 200;
                        $response->message = "dikenali.";
                        $response->data = view('silastri/adm/dashboardp3ke/statistik_rekap_p3ke_airminum', $x);
                        return json_encode($response);
                        break;
                    ...
                    case 'jenis_dinding':
                        ...
                        $response->status = 200;
                        $response->message = "dikenali.";
                        $response->data = view('silastri/adm/dashboardp3ke/statistik_rekap_p3ke_jenis_dinding', $x);
                        return json_encode($response);
                        break;
                    case 'kepemilikan_tempat':
                        ...
                        $response->status = 200;
                        $response->message = "dikenali.";
                        $response->data = view('silastri/adm/dashboardp3ke/statistik_rekap_p3ke_kepemilikan_tempat', $x);
                        return json_encode($response);
                        break;
                    case 'pekerjaan':
                        $result = $this->_db->table('ref_p3ke_individu a')
                        ...
                        $response->status = 200;
                        $response->message = "dikenali.";
                        $response->data = view('silastri/adm/dashboardp3ke/statistik_rekap_p3ke_pekerjaan', $x);
                        return json_encode($response);
                        break;
                    case 'resiko_stunting':
                        ...
                        $response->status = 200;
                        $response->message = "dikenali.";
                        $response->data = view('silastri/adm/dashboardp3ke/statistik_rekap_p3ke_resiko_stunting', $x);
                        return json_encode($response);
                        break;
