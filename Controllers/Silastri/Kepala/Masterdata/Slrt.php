...
namespace App\Controllers\Silastri\Kepala\Masterdata;

use App\Controllers\BaseController;
use App\Models\Silastri\Kepala\Masterdata\SlrtModel;
use Config\Services;
...
class Slrt extends BaseController
{
    ...
    {
        return redirect()->to(base_url('silastri/kepala/masterdata/slrt/data'));
    }
    ...
    public function data()
    {
        ...
        return view('silastri/kepala/masterdata/slrt/index', $data);
    }
    ...
    public function detail()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            if (count($current) > 0) {
                ...
                $response->data = view('silastri/kepala/masterdata/slrt/detail', $data);
                return json_encode($response);
            } else {
                $response = new \stdClass;
                $response->status = 400;
