...
class Home extends BaseController
{
    ...
    public function getAllStatistik()
    {
        ...
        (SELECT COUNT(*) FROM _permohonan) +
        (SELECT COUNT(*) FROM _permohonan_tolak) +
        (SELECT COUNT(*) FROM _permohonan_temp) +
        (SELECT COUNT(*) FROM _pengaduan) +
        (SELECT COUNT(*) FROM _pengaduan_tolak) AS jumlah_permohonan, 
        (SELECT COUNT(*) FROM _permohonan) +
        (SELECT COUNT(*) FROM _permohonan_tolak) +
        (SELECT COUNT(*) FROM _permohonan_temp) AS jumlah_permohonan_layanan,
        (SELECT COUNT(*) FROM _pengaduan) +
        (SELECT COUNT(*) FROM _pengaduan_tolak) AS jumlah_permohonan_pengaduan");
