...
class Rpbs extends BaseController
{
    ...
    {
        return redirect()->to(base_url('silastri/peng/layanan/rpbs/add'));
    }

    public function add()
    {
        $data['title'] = 'Rekomendasi Permohonan Bantuan Sosial ke Lembaga Sosial';
        ...
        return view('silastri/peng/layanan/rpbs/add', $data);
    }
    ...
    public function addSave()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $kodeUsulan = "RPBS-" . $user->data->nik . '-' . time();
            ...
            $data = [
                ...
                'jenis' => 'Rekomendasi Permohonan Bantuan Sosial ke Lembaga Sosial',
                'layanan' => "RPBS",
