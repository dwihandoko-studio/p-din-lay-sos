...
class Rbp extends BaseController
{
    ...
    {
        return redirect()->to(base_url('silastri/peng/layanan/rbp/add'));
    }

    public function add()
    {
        $data['title'] = 'Layanan Rekomendasi Bantuan Pendidikan';
        ...
        return view('silastri/peng/layanan/rbp/add', $data);
    }
    ...
    public function addSave()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $kodeUsulan = "RBP-" . $user->data->nik . '-' . time();
            ...
            $data = [
                ...
                'jenis' => 'Rekomendasi Bantuan Pendidikan',
                'layanan' => "RBP",
