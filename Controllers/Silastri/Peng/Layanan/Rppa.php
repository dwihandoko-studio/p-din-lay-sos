...
class Rppa extends BaseController
{
    ...
    public function add()
    {
        $data['title'] = 'Rekomendasi Permohonan Pengangkatan Anak';
    ...
    public function addSave()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $kodeUsulan = "PPA-" . $user->data->nik . '-' . time();
            ...
            $data = [
                ...
                'jenis' => 'Rekomendasi Permohonan Pengangkatan Anak',
                'layanan' => "PPA",
