...
class Rplrs extends BaseController
{
    ...
    {
        return redirect()->to(base_url('silastri/peng/layanan/rplrs/add'));
    }

    public function add()
    {
        $data['title'] = 'Layanan Rekomendasi Permohonan Layanan Rehabilitasi Sosial';
        ...
        return view('silastri/peng/layanan/rplrs/add', $data);
    }
    ...
    public function addSave()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $kodeUsulan = "RPLRS-" . $user->data->nik . '-' . time();
            ...
            $data = [
                ...
                'jenis' => 'Rekomendasi Permohonan Layanan Rehabilitasi Sosial',
                'layanan' => "RPLRS",
