...
class Pipa extends BaseController
{
    ...
    {
        return redirect()->to(base_url('silastri/peng/layanan/pipa/add'));
    }

    public function add()
    {
        $data['title'] = 'Layanan Pemberian Izin Pengasuhan Anak';
        ...
        return view('silastri/peng/layanan/pipa/add', $data);
    }
    ...
    public function addSave()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $kodeUsulan = "PIPA-" . $user->data->nik . '-' . time();
            ...
            $data = [
                ...
                'jenis' => 'Pemberian Izin Pengasuhan Anak',
                'layanan' => "PIPA",
