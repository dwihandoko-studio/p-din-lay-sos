...
class Rpbp extends BaseController
{
    ...
    {
        return redirect()->to(base_url('silastri/peng/layanan/rpbp/add'));
    }

    public function add()
    {
        $data['title'] = 'Layanan Rekomendasi Pembebasan Biaya Perawatan';
        ...
        return view('silastri/peng/layanan/rpbp/add', $data);
    }
    ...
    public function addSave()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $kodeUsulan = "RPBP-" . $user->data->nik . '-' . time();
