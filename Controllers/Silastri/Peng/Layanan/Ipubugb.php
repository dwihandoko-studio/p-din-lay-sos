...
class Ipubugb extends BaseController
{
    ...
    {
        return redirect()->to(base_url('silastri/peng/layanan/ipubugb/add'));
    }

    public function add()
    {
        $data['title'] = 'Layanan Izin Pengumpulan Uang dan Barang (PUB) dan Undian Gratis Berhadiah (UGB)';
        ...
        return view('silastri/peng/layanan/ipubugb/add', $data);
    }
    ...
    public function addSave()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $kodeUsulan = "IPUBUGB-" . $user->data->nik . '-' . time();
            ...
            $data = [
                ...
                'jenis' => 'Izin Pengumpulan Uang dan Barang (PUB) dan Undian Gratis Berhadiah (UGB)',
                'layanan' => "IPUBUGB",
