<form id="formAddModalData" action="./uploadSave" method="post" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="mb-3">
                    <label class="col-form-label">Keterangan Kesehatan:</label>
                    <textarea rows="5" class="form-control" id="_keterangan_kesehatan" name="_keterangan_kesehatan" required></textarea>
                </div>
            </div>
            <!-- <div class="col-lg-12">
                <div class="row">
...
<script>
    ...
    $("#formAddModalData").on("submit", function(e) {
        ...
        const keterangan_kesehatan = document.getElementsByName('_keterangan_kesehatan')[0].value;
        ...
        formUpload.append('keterangan_kesehatan', keterangan_kesehatan);
