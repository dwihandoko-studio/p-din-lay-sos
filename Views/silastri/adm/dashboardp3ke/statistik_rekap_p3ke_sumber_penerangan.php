                ...
                <div class="card-body">
                    ...
                    <div class="tab-content p-3 text-muted">
                                        ...
                                        <?php if (count($data)) { ?>
                                            ...
                                            <?php foreach ($data as $key => $value) { ?>
                                                <tr>
                                                    ...
                                                    <td><?= htmlspecialchars($value->sumber_penerangan) ?></td>
                        ...
                        <div class="tab-pane" id="grafiktab" role="tabpanel">
                            <h4 class="mb-4">Rekapitulasi Data Sumber Penerangan P3KE</h4>
    ...
    <script>
        ...
        $dataNya = [
            'labels' => array_map(function ($item) {
                return $item->sumber_penerangan;
            }, $data),
            'datasets' => [
                [
                    'label' => 'Data Sumber Penerangan P3KE',
