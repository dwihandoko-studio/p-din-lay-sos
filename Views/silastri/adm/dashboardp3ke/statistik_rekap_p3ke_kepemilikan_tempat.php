                ...
                <div class="card-body">
                    ...
                    <div class="tab-content p-3 text-muted">
                                        ...
                                        <?php if (count($data)) { ?>
                                            ...
                                            <?php foreach ($data as $key => $value) { ?>
                                                <tr>
                                                    ...
                                                    <td><?= htmlspecialchars($value->kepemilikan_rumah) ?></td>
                        ...
                        <div class="tab-pane" id="grafiktab" role="tabpanel">
                            <h4 class="mb-4">Rekapitulasi Data Kepemilikan Tempat P3KE</h4>
    ...
    <script>
        ...
        $dataNya = [
            'labels' => array_map(function ($item) {
                return $item->kepemilikan_rumah;
            }, $data),
            'datasets' => [
                [
                    'label' => 'Data Kepemilikan Tempat P3KE',
