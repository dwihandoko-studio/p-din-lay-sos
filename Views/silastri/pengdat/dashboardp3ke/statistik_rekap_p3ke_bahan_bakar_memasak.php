                ...
                <div class="card-body">
                    ...
                    <div class="tab-content p-3 text-muted">
                                        ...
                                        <?php if (count($data)) { ?>
                                            ...
                                            <?php foreach ($data as $key => $value) { ?>
                                                <tr>
                                                    ...
                                                    <td><?= htmlspecialchars($value->bahan_bakar_memasak) ?></td>
                        ...
                        <div class="tab-pane" id="grafiktab" role="tabpanel">
                            <h4 class="mb-4">Rekapitulasi Data Bahan Bakar Memasak P3KE</h4>
    ...
    <script>
        ...
        $dataNya = [
            'labels' => array_map(function ($item) {
                return $item->bahan_bakar_memasak;
            }, $data),
            'datasets' => [
                [
                    'label' => 'Bahan Bakar Memasak Data P3KE',
