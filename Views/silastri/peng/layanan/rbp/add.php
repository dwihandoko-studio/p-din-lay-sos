    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Buat Permohonan Rekomendasi Bantuan Pendidikan</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="col-xl-12">
            <form id="formAddData" action="./addSave" method="post" enctype="multipart/form-data">
                <div class="card mb-1">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Permohonan Surat Rekomendasi Bantuan Pendidikan</h4>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="row mb-2">
...
<script>
    $("#formAddData").on("submit", function(e) {
        ...
        Swal.fire({
            ...
            text: "Ajukan permohonan : Rekomendasi Bantuan Pendidikan",
