...
class P3keModel extends Model
{
    ...
    private function _get_datatables_query()
    {
        ...
        $this->dt->orderBy('a.updated_at', 'DESC');
    ...
    function get_datatables()
    {
        ...
        if ($this->request->getPost('desil')) {
            if ($this->request->getPost('desil') !== "") {

                $this->dt->where('a.desil_kesejahteraan', $this->request->getPost('desil'));
            }
        }
        if ($this->request->getPost('kecamatan')) {
            if ($this->request->getPost('kecamatan') !== "") {

                $this->dt->where('a.id_kecamatan', $this->request->getPost('kecamatan'));
            }
        }
