...
namespace App\Models\Silastri\Pengdat\Upload;
...
{
    protected $table = "tb_matching_p3ke a";
    protected $column_order = array(null, null, 'a.jenis', 'a.fullname', 'a.jumlah', 'a.created_at');
