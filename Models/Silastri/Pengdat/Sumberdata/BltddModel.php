...
namespace App\Models\Silastri\Pengdat\Sumberdata;

use CodeIgniter\HTTP\RequestInterface;
use CodeIgniter\Model;

class BltddModel extends Model
{
    protected $table = "ref_bltdd a";
    protected $column_order = array(null, null, 'a.nama', 'a.nik', null);
